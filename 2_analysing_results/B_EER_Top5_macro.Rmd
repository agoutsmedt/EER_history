...
## Preparing community inspections and EU/US comparison
...
for (com in com_to_inspect) {
  ...
  most_productive_institutions_odds <- merge(alluv_com[,.(Id,EU_US_collab,Revue)], institutions[,.(ID_Art, Institution)], by.x= "Id", by.y= "ID_Art")
  most_productive_institutions_odds <- merge(most_productive_institutions_odds, Corpus[,.(ID_Art, journal_type)], by.x= "Id", by.y= "ID_Art",all.x=TRUE)
