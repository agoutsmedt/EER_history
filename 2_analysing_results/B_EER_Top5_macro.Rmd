...
plot_odds_bw <- ggplot(diff_stat_euro_com, aes(x = europeans_authors_diff_odds, y = EER_articles_diff_odds)) +
  ...
  theme_classic(base_size = 9) +
  guides(size = "none") + theme(legend.position = "bottom")
ggsave(here(eer_data,"pictures","Graphs","Communities_europeanisation_colored_odds_bw.png"), width=30, height=20, units = "cm", scaling = 1.5)
...
ggsave(here(eer_data,"pictures","Graphs","Communities_europeanisation__chi_big_com_mean.png"), width=30, height=20, units = "cm", scaling = 1.5)
saveRDS(diff_stat_euro_com,here(eer_data,"2_Raw_Networks_and_Alluv","euro_vs_us_communities.rds"))
