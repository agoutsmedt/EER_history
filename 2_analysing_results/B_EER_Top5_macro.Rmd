...
ggplot(count[Annee_Bibliographique>1970 & Annee_Bibliographique<=2002], aes(x=Annee_Bibliographique , y=share,color=Journal_label)) +
  ...
  labs(title = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","EER_importance.png"), width=40, height=30, units = "cm", scaling = 1.7)
...
ggsave(here(eer_data,"pictures","Graphs","EER_importance_econ.png"), width=40, height=30, units = "cm", scaling = 1.7)
...
ggplot(count[Annee_Bibliographique>1970 & Annee_Bibliographique<=2002], aes(x=Annee_Bibliographique , y=share,color=Journal_label)) +
  ...
  labs(title = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","EER_importance_macro.png"), width=40, height=30, units = "cm", scaling = 1.7)
...
ggplot(g1_citation, aes(x=Annee_Bibliographique , y=share, color=color)) +
  ...
  # geom_point(alpha=1) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.75)) +
  scale_y_continuous("Share of Articles in  our Corpus Citing", labels = scales::percent_format()) +
...
ggplot(obs_th_comparison[!is.na(y)], aes(x=Annee_Bibliographique , y=-1*y, color=color, group=color)) +
  ...
  scale_colour_identity() 
  # ggplot2::annotate("text", x = 1985, y = 0.35, label = "Log ratio of share of relative citations", size=5,color="Darkgrey")
...
ggplot(g2_citation[Annee_Bibliographique<=1995], aes(x=Annee_Bibliographique , y=share, color=color)) +
  ...
  # geom_point(alpha=0.1) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.75)) +
  scale_y_continuous("Share of Articles in Corpus Citing References", labels = scales::percent_format()) +
...
${\displaystyle\text{EU/US Over-citations}= -1 \times\log(\frac{\text{Share of References from American Articles to Specific References}}{\text{Overall Share of References from American Articles}})}$
