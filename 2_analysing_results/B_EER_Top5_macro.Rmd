...
plot_resid_big_com <- ggplot(plot_resid, aes(x=1*mean.y, y=1*mean.x, label = Label_com.x)) + 
  ...
  labs(title = NULL,
       color = NULL,
       x = "Residuals of European Only Authors: under-representation (left) vs. over-representation (right)",
       y = "Residuals of European Only Authors: under-representation (left) vs. over-representation (right)") + 
  theme_classic(base_size = 9) +
  guides(size = "none") + 
  theme(legend.position = "bottom")
