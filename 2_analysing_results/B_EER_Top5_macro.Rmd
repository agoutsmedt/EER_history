...
ggsave(here(eer_data,"pictures","Graphs","mean_jel.png"), width=40, height=15, units = "cm", scaling = 2)
...
ggplot(count_year, aes(x=as.numeric(Annee_Bibliographique), y=freq, group=EU_US_collab, color=EU_US_collab)) +
  ...
  scale_y_continuous("Share of Papers Belonging to a Pattern of Collaboration", limits = c(0, NA), breaks = seq(0,.8,0.2), labels = scales::label_percent()) +
  theme_minimal() +
  theme(plot.background = element_rect(fill = 'white', colour = NA)) +
...
ggplot(count_year[intra_eu_collab_bin==1], aes(x=as.numeric(Annee_Bibliographique), y=freq)) +
  ...
  # geom_point(alpha=0.2) +
  scale_x_continuous(NULL) +
  scale_y_continuous("Share of Papers Written by Europeans Authors from Different Countries", limits = c(0, NA), labels = scales::label_percent()) +
  theme_minimal() +
  theme(plot.background = element_rect(fill = 'white', colour = NA)) +
  # scale_color_manual(values = c(rev(brewer.pal(n = 7, name = "Dark2"))),guide = FALSE) +
  # scale_color_discrete( +
...
count_year_all[EU_US_collab=="Collaboration", EU_US_collab:="EU-US Collab"]
...
ggplot(count_year_all, aes(x=as.numeric(Annee_Bibliographique), y=freq, linetype=EU_US_collab, color=EU_US_collab)) +
  ...
  # geom_point(alpha=0.2) +
  scale_x_continuous(NULL) +
  scale_y_continuous("Share of Papers Belonging to a Pattern of Collaboration", limits = c(0, NA), breaks = seq(0,1,0.2), labels = scales::label_percent()) +
  theme_minimal() +
  theme(plot.background = element_rect(fill = 'white', colour = NA)) +
...
#                   label="Smoothed using local polynomial regression",
#                   color="Darkgrey")
ggsave(here(eer_data,"pictures","Graphs","Intra_vs_US_collab.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggplot(count[Annee_Bibliographique>1970 & Annee_Bibliographique<=2002 & Code_Revue!=12488 & Code_Revue!=14501 & Code_Revue!=16273], aes(x=Annee_Bibliographique , y=share, color=color_bw, linetype = line_type)) +
  ...
  labs(title = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","EER_importance_macro_minimal_bw.png"), width=40, height=20, units = "cm", scaling = 2)
```
...
ggplot(g1_citation, aes(x=Annee_Bibliographique , y=share, color=color)) +
  ...
  labs(title = NULL,
       color = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","g1_citations.png"), width=40, height=20, units = "cm", scaling = 1.7)
...
ggplot(g1_citation, aes(x=Annee_Bibliographique , y=share, color=color_bw, linetype = line_type)) +
  ...
  labs(title = NULL,
       color = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","g1_citations_bw.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggsave(here(eer_data,"pictures","Graphs","g1_over_citations.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggplot(obs_th_comparison[!is.na(y)], aes(x=Annee_Bibliographique , y=-1*y, color=color_bw, group=color, linetype = line_type)) +
  ...
  ggplot2::annotate("text", x = 1988.5, y = 0.35, 
                    label=TeX(r'($LogRatio=-1 \times\log(\frac{Share\,of\,Citations\,from\,American\,Articles\,to\,Specific\,References}{Overall\,Share\,of\,Citations\,from\,American\,Articles})$)'), 
                    size=3.5,color="Darkgrey", parse = TRUE)
ggsave(here(eer_data,"pictures","Graphs","g1_over_citations_bw.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggplot(g2_citation[Annee_Bibliographique<=1995], aes(x=Annee_Bibliographique , y=share, color=color)) +
  ...
  labs(title = NULL,
       color = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","g2_citations.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggplot(g2_citation[Annee_Bibliographique<=1995], aes(x=Annee_Bibliographique, y=share, color=color_bw, linetype = line_type)) +
  ...
  labs(title = NULL,
       color = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","g2_citations_bw.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggplot(obs_th_comparison[!is.na(y) & Annee_Bibliographique<=1992], aes(x=Annee_Bibliographique , y=-1*y, color=color, group=color)) +
  ...
  ggplot2::annotate("text", x = 1981.5, y = 0.19, 
                    label=TeX(r'($LogRatio=-1 \times\log(\frac{Share\,of\,Citations\,from\,American\,Articles\,to\,Specific\,References}{Overall\,Share\,of\,Citations\,from\,American\,Articles})$)'), 
                    size=3.5,color="Darkgrey", parse = TRUE)
ggsave(here(eer_data,"pictures","Graphs","g2_over_citations.png"), width=40, height=20, units = "cm", scaling = 2)
...
ggplot(obs_th_comparison[!is.na(y) & Annee_Bibliographique<=1992], aes(x=Annee_Bibliographique , y=-1*y, color=color_bw, linetype = line_type)) +
  ...
  ggplot2::annotate("text", x = 1981.5, y = 0.19, 
                    label=TeX(r'($LogRatio=-1 \times\log(\frac{Share\,of\,Citations\,from\,American\,Articles\,to\,Specific\,References}{Overall\,Share\,of\,Citations\,from\,American\,Articles})$)'), 
                    size=3.5,color="Darkgrey", parse = TRUE)
ggsave(here(eer_data,"pictures","Graphs","g2_over_citations_bw.png"), width=40, height=20, units = "cm", scaling = 2)
...
plot_resid_big_com <- ggplot(plot_resid, aes(x=1*mean.y, y=1*mean.x, label = Label_com.x)) + 
  ...
  labs(title = NULL,
       color = NULL,
       x = "Mean Residuals of European Only Authors: less European (left) vs. more European (right)",
