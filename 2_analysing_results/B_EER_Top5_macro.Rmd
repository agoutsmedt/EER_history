...
ggsave(here(eer_data,"pictures","Graphs","mean_jel.png"), width=30, height=17, units = "cm", scaling = 1.7)
...
ggplot(count_year_all, aes(x=as.numeric(Annee_Bibliographique), y=freq, linetype=EU_US_collab, color=EU_US_collab)) +
  ...
  ggrepel::geom_label_repel(aes(label = EU_US_collab), data = count_year_all[Annee_Bibliographique==2001], nudge_x = 2, nudge_y = 0.01, segment.color = NA, force = 2, force_pull = 10) +
  coord_cartesian(xlim = c(NA, 2008))
# ggplot2::annotate("text", x = max(2008), y = min(count_year$freq), hjust=0.95, vjust=-1,
#                   label="Smoothed using local polynomial regression",
#                   color="Darkgrey")
ggsave(here(eer_data,"pictures","Graphs","Intra_vs_US_collab.png"), width=30, height=20, units = "cm", scaling = 1.7)
...
ggplot(count[Annee_Bibliographique>1970 & Annee_Bibliographique<=2002 & Code_Revue!=12488 & Code_Revue!=14501 & Code_Revue!=16273], aes(x=Annee_Bibliographique , y=share, color=color_bw, linetype = line_type)) +
  ...
  labs(title = NULL,
       x = NULL) 
ggsave(here(eer_data,"pictures","Graphs","EER_importance_macro_minimal_bw.png"), width=30, height=20, units = "cm", scaling = 1.7)
```
