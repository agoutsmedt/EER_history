...
ggsave(here(eer_data,"pictures","Graphs","mean_diff_plot_new_bw.png"), width=30, height=20, units = "cm", scaling = 1.5)
...
ggplot(topic_diff_summary, aes(x = diff_affiliation, y = diff_journal)) +
  ...
  ggrepel::geom_text_repel(
    ...
    segment.linetype=	"dashed",
    segment.size = 0.3) 
ggsave(here(eer_data,"pictures","Graphs","mean_diff_plot_new_bw2.png"), width=30, height=20, units = "cm", scaling = 1.5)
...
ggplot(topic_diff_summary, aes(x = logratio_affiliation, y = logratio_journal)) +
  ...
  ggrepel::geom_text_repel(
    ...
    segment.size = 0.3) 
# ggsave(here(tm_picture_path, "logratio_diff_plot_new_bw.png"), width=40, height=20, units = "cm", scaling = 1.5)
ggsave(here(eer_data,"pictures","Graphs","logratio_diff_plot_new_bw2.png"), width=30, height=20, units = "cm", scaling = 1.5)
