...
format <- str_detect(knitr::opts_knit$get("rmarkdown.pandoc.to"), "pdf")
```
...
topics_summary  %>% 
  kbl(caption="Summary of Topics",
      ...
      align="llcc") %>%
 # column_spec(1, latex_valign = "m") %>%
  column_spec(2, width = "25em", latex_valign = "m") %>%
  #column_spec(3, latex_valign = "m") %>%
  #column_spec(4, latex_valign = "m") %>%
